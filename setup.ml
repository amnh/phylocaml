...
(* OASIS_START *)
(* DO NOT EDIT (digest: c3392be067646bbf465a579f241e5407) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("API", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("API", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = Some "http://github.com/AMNH/phylocaml";
          synopsis = "A Phylogenetics Library for OCaml";
          description = Some "A Phylogenetics Library for OCaml";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("pareto", None)];
                      bs_build_tools =
                        [
                      ...
                      bs_c_sources =
                        ["mlmodel.c"; "mlmodel.h"; "seq.c"; "seq.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                   ...
                   {
                      lib_modules = ["Phylocaml"];
                      lib_pack = false;
                      lib_internal_modules = ["Internal"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_install_dir = "$htmldir/phylocaml";
                      doc_title = "API reference for Phylocaml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\190\024\0163UD^\014\212\1489\030\\\1551\218";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
