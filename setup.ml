...
(* OASIS_START *)
(* DO NOT EDIT (digest: bdbad5dd8f8e52d047dfc76a3a1201fc) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources =
                        ["mlmodelc.c"; "mlmodelc.h"; "seq.c"; "seq.h"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                      ...
                      },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = ["Phylocaml_pervasives"];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\234z\226A\157\232\151\202^\220H+t\178]S";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
