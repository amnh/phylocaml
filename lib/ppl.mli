...
val l_matrix :
  ?align:align array -> 'a pp_l -> ('a array array) pp_l

(** Generate a matrix of values with a header row for LaTeX compilation. *)
val l_table :
  ?align:align array -> 'a pp_l -> 'b pp_l -> ('a array * 'b array array) pp_l

(** Generate a matrix of values with a labeled column and row of LaTeX *)
val l_datatable :
  ?align:align array -> 'a pp_l -> 'b pp_l -> 'c pp_l -> ('a array * 'b array * 'c array array) pp_l
