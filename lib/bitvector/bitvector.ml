...
module BV8 : BV = struct
  ...
  external cardinal : t -> elt = "bv8_CAML_cardinal"

  external create : int -> t = "bv8_CAML_create"
  external copy : t -> t = "bv8_CAML_copy"
  external of_array : elt array -> t = "bv8_CAML_ofarray"
  ...
  external fitch_median_2 : t -> t -> t = "bv8_CAML_fitch_median2"
end
...
module BV16 : BV = struct
  ...
  external cardinal : t -> elt = "bv16_CAML_cardinal"

  external create : int -> t = "bv16_CAML_create"
  external copy : t -> t = "bv16_CAML_copy"
  external of_array : elt array -> t = "bv16_CAML_ofarray"
  ...
  external fitch_median_2 : t -> t -> t = "bv16_CAML_fitch_median2"
end
...
module BV32 : BV = struct
  ...
  external cardinal : t -> elt = "bv32_CAML_cardinal"

  external create : int -> t = "bv32_CAML_create"
  external copy : t -> t = "bv32_CAML_copy"
  external of_array : elt array -> t = "bv32_CAML_ofarray"
  ...
  external fitch_median_2 : t -> t -> t = "bv32_CAML_fitch_median2"
end
...
module BV64 : BV = struct
  ...
  external cardinal : t -> elt = "bv64_CAML_cardinal"

  external create : int -> t = "bv64_CAML_create"
  external copy : t -> t = "bv64_CAML_copy"
  external of_array : elt array -> t = "bv64_CAML_ofarray"
  ...
  external fitch_median_2 : t -> t -> t = "bv64_CAML_fitch_median2"
end
